/*********************************************************************************
Name:           VehicalCurrentOwnerShipController
Author:         Himanshu Verma [Fujitsu]
Purpose:        It Updates the Current OwnerShip History in the Component on the basis of RecordId 
...
({
	fetchOwnersAction : function(component, event, helper) {
		...
		var action =component.get("c.fetchCurrentOwners");
