/*********************************************************************************
Name:           VehicalPlatehistoryController
Author:         Himanshu Verma [Fujitsu]
Purpose:        It Updates the PlateHistory in the Component on the basis of RecordId 
...
({
	fetchPlateHistoryAction : function(component, event, helper) {
		...
		var action =component.get("c.fetchVehicalPlateHistory");
